...
const DAY_LIMIT = HOUR_LIMIT * 365;
...
function CommentItem({ commentItem }: CommentItemProps) {
    ...
    : diffWriteDate < HOUR_LIMIT ? Math.floor(diffWriteDate / MINUTE_LIMIT) + '시간 전'
    : diffWriteDate < DAY_LIMIT ? Math.floor(diffWriteDate / HOUR_LIMIT) + '일 전'
    : Math.floor(diffWriteDate / DAY_LIMIT) + '년 전'
        ...
        <div className='comment-box'>
            <div className='title-box'>
                ...
                <div className='edit-delete-box'>
                    <div className='divider'></div>
                    <div className='edit-delete'>수정</div>
                    <div className='divider'></div>
...
export default function DiaryDetail() {
    ...
    // function: get empathy reponse 처리 함수 //
