...
export default function SignIn(props: Props) {
    ...
    const onUserPasswordChangeHanlder = (event: ChangeEvent<HTMLInputElement>) => {
        const { value } = event.target;
    ...
    <div id='auth-login-container'>
        ...
        <div className='input-container'>
            <InputBox type={'text'} label={'아이디'} value={userId} placeholder={'아이디를 입력해주세요.'} message={userIdMessage} isErrorMessage onChange={onUserIdChangeHanlder}/>
            <InputBox type={'password'} label={'비밀번호'} value={userPassword} placeholder={'비밀번호를 입력해주세요.'} message={userPasswordMessage} isErrorMessage onChange={onUserPasswordChangeHanlder}/>
        </div>
